...
class MyOwnOngoingContractDataSource  (private val contractType: String, private val apiService: ApiService) : PagingSource<Int, OngoingContractsItem>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, OngoingContractsItem> {
        ...
        return try {
            ...
            * */
            ...
            LoadResult.Page(
                data = response.content?.results?.ongoingContracts!!,
