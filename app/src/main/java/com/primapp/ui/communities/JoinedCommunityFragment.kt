...
class JoinedCommunityFragment : BaseFragment<FragmentJoinedCommunityBinding>() {
    ...
    private fun searchCommunity(query: String?) {
        ...
        searchJob = lifecycleScope.launch {
            viewModel.getCommunityListData(
                ...
                query,
                CommunityFilterTypes.JOINED_COMMUNITY
    ...
    private fun setAdapter() {
        ...
        adapter.addLoadStateListener { loadState ->
            if (loadState.refresh !is LoadState.Loading) {
                ...
                binding.tvJoinedCommunityDescription.visible(adapter.snapshot().isEmpty())
