package com.primapp.ui.communities.details.source
...
class CommunitiesPostListDataSource(private val apiService: ApiService, private val communityId: Int) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, PostListResult> {
        ...
        return try {
            ...
            * */
            ...
            val response = apiService.getCommunityPostList(communityId, offset, params.loadSize)
            LoadResult.Page(
