package com.primapp.ui.post.source
...
class PostListPageDataSource(private val apiService: ApiService) : PagingSource<Int, PostListResult>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, PostListResult> {
        ...
        return try {
            ...
            * */
            ...
            val response = apiService.getPostList(offset, params.loadSize)
            LoadResult.Page(
