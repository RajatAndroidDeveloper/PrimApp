...
import kotlinx.android.synthetic.main.view_chat_header_date.view.*

class RecyclerDateSectionItemDecoration(
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (headerView == null) {
            ...
            tvDateHeader=headerView!!.tvDateHeader
    ...
    private fun inflateHeaderView(parent: RecyclerView): View {
        return LayoutInflater.from(parent.context)
            .inflate(R.layout.view_chat_header_date, parent, false)
    }
